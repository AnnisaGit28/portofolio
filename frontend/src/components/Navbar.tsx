        ...
        <nav className="fixed top-0 left-0 right-0 z-50 bg-gray-950/80 backdrop-blur-xl border-gray-800/50">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    <link href="/" className="text-xl front-bold bg-gradient-to-r
                    from-indigo-400 to-violet-400 bg-clip-text text-transparant
                    ...
                    <button onClick={() => setMobileOpen(!mobileOpen)}
                        ...
                        hover:bg-gray-800/50 transition-all duration-300" arial-label="Toggle Menu">
                            <div className="flex flex-col gap-1.5">
                                <span className={`block w-5 h-0.5 bg-current
                                    teransition-all duration-300 ${mobileOpen ? "rotate-45 translate-y-2" :""}`}/>
                                <span className={`block w-5 h-0.5 bg-current 
