...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      {/* Welcome Banner */}
      <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-900/40 via-violet-900/30 to-purple-900/20 border border-indigo-800/30 p-6">
          ...
          {loading ? (
            ...
            <div className="space-y-3 flex-1">
              {messages.slice(0, 5).map((msg) => (
                <div
                  key={msg.id}
                  className="p-4 rounded-xl bg-gray-950/60 border border-gray-800/50 hover:border-gray-700/60 transition-colors flex items-start gap-4"
                >
        ...
        <div className="p-6 rounded-2xl bg-gray-900/50 border border-gray-800/60 space-y-4">
          ...
          <div className="pt-4 mt-4 border-t border-gray-800/60">
            <div className="p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/20 text-xs text-indigo-300 leading-relaxed">
              ...
              data (CRUD) untuk setiap modul di atas.
            </div>
          </div>
        </div>
      </div>
